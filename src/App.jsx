...
function App() {
  ...
  const steps = [
    ['Plan', Calendar, 'Share your vision and let us create your perfect day'],
    ['Personalize', Heart, 'Customize every detail to match your style'],
    ['Celebrate', Users, 'Enjoy your special day while we handle everything']
  ];

  const services = [
    ['Venue Selection', MapPin, 'Find your perfect location'],
    ['Decor', Heart, 'Beautiful styling & themes'],
    ['Photography', Camera, 'Capture precious moments'],
    ['Coordination', Clock, 'Seamless event management']
  ];

  const testimonials = [
    [
      "Wedora made our dream wedding a reality. Every detail was perfect!",
      "Priya & Arjun",
      "https://images.unsplash.com/photo-1583939003579-730e3918a45a?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
    ],
    [
      "The most stress-free wedding planning experience we could have asked for.",
      "Meera & Raj",
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {steps.map(([title, Icon, description], index) => (
              <div key={index} className="text-center">
                ...
                <h3 className="text-2xl font-serif mb-4 text-gray-800">{title}</h3>
      ...
      <section className="py-20 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {testimonials.map(([quote, couple, image], index) => (
              <div key={index} className="bg-white p-8 rounded-lg shadow-lg">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-rose-500 font-serif">{couple}</p>
                  </div>
                </div>
              </div>
            ))}
